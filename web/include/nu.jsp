<%-- 
    Document   : nu
    Created on : Jun 22, 2024, 6:35:39 PM
    Author     : LENOVO
--%>
                        ...
                        <div class="carousel-inner">
                                ...
                                <div class="row row-cols-1 row-cols-md-4 g-4">
                                    ...
                                    <div class="col">
                                        <div class="card h-100">
                                            ...
                                            <!-- <img src="/web/image/jordan.jpg" class="card-img-top" alt="..."> -->
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                    ...
                                    <div class="col">
                                        <div class="card h-100">
                                            <video  class="card-img-top" src="https://brand.assets.adidas.com/video/upload/f_auto:video,q_auto/if_w_gt_400,w_400/running_ss24_adizero_launch_glpw_teasercard_d_b4dde293df.mp4" muted autoplay></video>
                            ...
                            <div class="carousel-item" data-bs-interval="2000">
                                <div class="row row-cols-1 row-cols-md-4 g-4">
                                    <div class="col">
                                        <div class="card h-100">
                                            <video  class="card-img-top" src="https://brand.assets.adidas.com/video/upload/f_auto:video,q_auto/if_w_gt_400,w_400/football_fw24_f50_launch_glp_w_teaser_carousel_animated_d_9418d28839.mp4" muted autoplay></video>
                                            <!-- <img src="/web/image/jordan.jpg" class="card-img-top" alt="..."> -->
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text">This is a longer card with supporting text below as
                                    ...
                                    <div class="col">
                                        <div class="card h-100">
                                            <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_400,w_400/Training_SS_24_Strength_global_Exit_GLP_Female_Teaser_Card_d_500b5a88e7.jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text">This is a longer card with supporting text below as
                                                    a natural lead-in to additional content.</p>
...
<script src="/web/js/video_Control.js"></script>
